# ВНИМАНИЕ ЖЮРИ ХАКАТОНА VK MAX! 

**В первоначальной версии презентации была опечатка от Gamma**  
На слайде «Решение» написано «Telegram-бот» → уже исправлено на **«MAX-бот»**

Исправленный PDF отправлен в поддержку Changellenge 16 ноября.  
Реализация — **100 % в мессенджере MAX**, токен использован, бот полностью рабочий.  
Демо-бот: @t319_hakaton_bot
